...
| ----------------------------------------------------------- | --------- | ----------- | ------ | ------------------ |
| [`web3_clientVersion`](broken-reference)                    | Web3      | ✔           | ✔      |                    |
| [`web3_sha3`](broken-reference)                             | Web3      | ✔           | ✔      |                    |
| [`net_version`](broken-reference)                           | Net       | ✔           | ✔      |                    |
| [`net_peerCount`](broken-reference)                         | Net       | ✔           | ✔      |                    |
| [`net_listening`](broken-reference)                         | Net       | ✔           | ✔      |                    |
| [`eth_protocolVersion`](broken-reference)                   | Eth       | ✔           | ✔      |                    |
| [`eth_syncing`](broken-reference)                           | Eth       | ✔           | ✔      |                    |
| [`eth_gasPrice`](broken-reference)                          | Eth       | ✔           | ✔      |                    |
| [`eth_accounts`](broken-reference)                          | Eth       | ✔           | ✔      |                    |
| [`eth_blockNumber`](broken-reference)                       | Eth       | ✔           | ✔      |                    |
| [`eth_getBalance`](broken-reference)                        | Eth       | ✔           | ✔      |                    |
| [`eth_getStorageAt`](broken-reference)                      | Eth       | ✔           | ✔      |                    |
| [`eth_getTransactionCount`](broken-reference)               | Eth       | ✔           | ✔      |                    |
| [`eth_getBlockTransactionCountByNumber`](broken-reference)  | Eth       | ✔           | ✔      |                    |
| [`eth_getBlockTransactionCountByHash`](broken-reference)    | Eth       | ✔           | ✔      |                    |
| [`eth_getCode`](broken-reference)                           | Eth       | ✔           | ✔      |                    |
| [`eth_sign`](broken-reference)                              | Eth       | ✔           | ✔      |                    |
| [`eth_sendTransaction`](broken-reference)                   | Eth       | ✔           | ✔      |                    |
| [`eth_sendRawTransaction`](broken-reference)                | Eth       | ✔           | ✔      |                    |
| [`eth_call`](broken-reference)                              | Eth       | ✔           | ✔      |                    |
| [`eth_estimateGas`](broken-reference)                       | Eth       | ✔           | ✔      |                    |
| [`eth_getBlockByNumber`](broken-reference)                  | Eth       | ✔           | ✔      |                    |
| [`eth_getBlockByHash`](broken-reference)                    | Eth       | ✔           | ✔      |                    |
| [`eth_getTransactionByHash`](broken-reference)              | Eth       | ✔           | ✔      |                    |
| [`eth_getTransactionByBlockHashAndIndex`](broken-reference) | Eth       | ✔           | ✔      |                    |
| [`eth_getTransactionReceipt`](broken-reference)             | Eth       | ✔           | ✔      |                    |
| [`eth_newFilter`](broken-reference)                         | Eth       | ✔           | ✔      |                    |
| [`eth_newBlockFilter`](broken-reference)                    | Eth       | ✔           | ✔      |                    |
| [`eth_newPendingTransactionFilter`](broken-reference)       | Eth       | ✔           | ✔      |                    |
| [`eth_uninstallFilter`](broken-reference)                   | Eth       | ✔           | ✔      |                    |
| [`eth_getFilterChanges`](broken-reference)                  | Eth       | ✔           | ✔      |                    |
| [`eth_getFilterLogs`](broken-reference)                     | Eth       | ✔           | ✔      |                    |
| [`eth_getLogs`](broken-reference)                           | Eth       | ✔           | ✔      |                    |
...
| `eth_mining`                                                | Eth       |             | ❌      |                    |
| [`eth_coinbase`](broken-reference)                          | Eth       | ✔           |        |                    |
...
| [`eth_getProof`](broken-reference)                          | Eth       | ✔           |        |                    |
| [`eth_subscribe`](broken-reference)                         | Websocket | ✔           |        |                    |
| [`eth_unsubscribe`](broken-reference)                       | Websocket | ✔           |        |                    |
| [`personal_importRawKey`](broken-reference)                 | Personal  | ✔           | ❌      |                    |
| [`personal_listAccounts`](broken-reference)                 | Personal  | ✔           | ❌      |                    |
| [`personal_lockAccount`](broken-reference)                  | Personal  | ✔           | ❌      |                    |
| [`personal_newAccount`](broken-reference)                   | Personal  | ✔           | ❌      |                    |
| [`personal_unlockAccount`](broken-reference)                | Personal  | ✔           | ❌      |                    |
| [`personal_sendTransaction`](broken-reference)              | Personal  | ✔           | ❌      |                    |
| [`personal_sign`](broken-reference)                         | Personal  | ✔           | ❌      |                    |
| [`personal_ecRecover`](broken-reference)                    | Personal  | ✔           | ❌      |                    |
| [`personal_initializeWallet`](broken-reference)             | Personal  | ✔           | ❌      |                    |
| [`personal_unpair`](broken-reference)                       | Personal  | ✔           | ❌      |                    |
| `db_putString`                                              | DB        |             |        |                    |
| `db_getString`                                              | DB        |             |        |                    |
| `db_putHex`                                                 | DB        |             |        |                    |
| `db_getHex`                                                 | DB        |             |        |                    |
...
| [`debug_traceBlock`](broken-reference)                      | Debug     | ✔           |        |                    |
| [`debug_traceBlockByNumber`](broken-reference)              | Debug     | ✔           |        |                    |
| [`debug_traceBlockByHash`](broken-reference)                | Debug     | ✔           |        |                    |
| `debug_traceBlockFromFile`                                  | Debug     |             |        |                    |
| `debug_standardTraceBlockToFile`                            | Debug     |             |        |                    |
| `debug_standardTraceBadBlockToFile`                         | Debug     |             |        |                    |
| [`debug_traceTransaction`](broken-reference)                | Debug     | ✔           |        |                    |
...
| [`miner_getHashrate`](broken-reference)                     | Miner     | ✔           | ❌      | No-op              |
| [`miner_setExtra`](broken-reference)                        | Miner     | ✔           | ❌      | No-op              |
| [`miner_setGasPrice`](broken-reference)                     | Miner     | ✔           | ❌      | Needs node restart |
| [`miner_start`](broken-reference)                           | Miner     | ✔           | ❌      | No-op              |
| [`miner_stop`](broken-reference)                            | Miner     | ✔           | ❌      | No-op              |
| [`miner_setGasLimit`](broken-reference)                     | Miner     | ✔           | ❌      | No-op              |
| [`miner_setEtherbase`](broken-reference)                    | Miner     | ✔           | ❌      |                    |
| [`txpool_content`](broken-reference)                        | TxPool    | ✔           |        |                    |
| [`txpool_inspect`](broken-reference)                        | TxPool    | ✔           |        |                    |
| [`txpool_status`](broken-reference)                         | TxPool    | ✔           |        |                    |
...
The account can be used with [`eth_sign`](broken-reference) and [`eth_sendTransaction`](broken-reference) while it is unlocked.
...
The transaction is the same argument as for [`eth_sendTransaction`](broken-reference) and contains the `from` address. If the passphrase can be used to decrypt the private key belonging to `tx.from` the transaction is verified, signed and send onto the network.
...
`ecRecover` returns the address associated with the private key that was used to calculate the signature in [`personal_sign`](broken-reference).

#### Parameters

* Message
* Signature returned from [`personal_sign`](broken-reference)
